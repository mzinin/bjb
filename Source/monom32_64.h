...
//вопрос - зачем эта функция и не оптимизировать ли ее? см. lm() в полиноме
  ...
  void mult1(const Monom32_64& a);
  void mult1(const Monom32_64& a, const Monom32_64& b);
  ...
  bool equality(const Monom32_64& a, int var) const;
...
inline void Monom32_64::prolong1(int var, int deg) {
  bitset<64> a0,a1;
...
inline void Monom32_64::mult1(const Monom32_64& a) {
  bitset<64> res = 0, a1;
  a1 = exp & mRealization->mask1; a1 = a1 >> 1;
  res |= a1;
...
inline void Monom32_64::mult1(const Monom32_64& a, const Monom32_64& b) {
  bitset<64> a1;
  exp = 0;
  a1 = a.exp & mRealization->mask1; a1 = a1 >> 1;
  exp |= a1;
...
inline bool Monom32_64::isHG() const{
  bitset<64> a1 = exp & mRealization->mask1;
  if (a1==0)
    return false;
  else
    return true;
...
inline int Monom32_64::num_of_only_var() const {
  int i = -1;
...
inline bool Monom32_64::equality(const Monom32_64& a, int var) const {
  bitset<64> d = a.exp;
  d.set(2*var);
  return exp==d;
}
